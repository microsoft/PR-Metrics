...
//       verify(octokitWrapper.initialize(deepEqual({
//         auth: 'ghp_000000000000000000000000000000000000',
...
//       // Assert
//       verify(octokitWrapper.initialize(deepEqual({ auth: 'ghp_000000000000000000000000000000000000', userAgent: 'PRMetrics/v1.2.0' }))).once()
