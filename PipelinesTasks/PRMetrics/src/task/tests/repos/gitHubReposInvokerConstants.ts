...
/**
 * A class encapsulating constants for the `GitHubReposInvoker` tests.
 */
export default abstract class GitHubReposInvokerConstants {
  /**
   * A mock response for the Octokit API call to get the pull request details.
   */
  public static readonly getPullResponse: GetPullResponse = {
    headers: {},
    status: 200,
    url: '',
    data: {
   ...
   */
  public static readonly listCommitsResponse: ListCommitsResponse = {
    headers: {},
    status: 200,
    url: '',
    data:
   ...
   */
  public static readonly getIssueCommentsResponse: GetIssueCommentsResponse = {
    headers: {},
    status: 200,
    url: '',
    data: [
   ...
   */
  public static readonly getReviewCommentsResponse: GetReviewCommentsResponse = {
    headers: {},
    status: 200,
    url: '',
    data: [
