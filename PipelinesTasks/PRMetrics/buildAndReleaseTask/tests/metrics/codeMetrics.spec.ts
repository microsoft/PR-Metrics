...
// import Parameters from '../../src/metrics/inputs'
...
//     when(taskLibWrapper.loc('metrics.codeMetrics.titleSizeIndicatorFormat', localizations.titleSizeXS, localizations.titleTestsSufficient)).thenReturn(localizations.titleSizeS + localizations.titleTestsSufficient)
...
//     when(taskLibWrapper.loc('metrics.codeMetrics.titleSizeIndicatorFormat', localizations.titleSizeXS, '')).thenReturn(localizations.titleSizeS)
...
//         const codeMetrics: CodeMetrics = new CodeMetrics(instance(gitInvoker), instance(parameters), instance(taskLibWrapper))
