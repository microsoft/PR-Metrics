...
PR Metrics is owned and maintained by the [Microsoft OMEX][omex] team within
Microsoft. The team has overall responsibility for the project's direction,
releases, and security.

## Members with Access to Sensitive Resources

The following list details individuals and teams with access to sensitive
resources, including the repository, release pipelines, and signing
infrastructure.

- **@microsoft/omex** (Team): Code review ownership (CODEOWNERS), repository
  maintainer access.
- **@muiriswoulfe** (Maintainer): Repository write access, release initiation,
  CI/CD configuration.
- **Repository maintainers** (Maintainer): Repository write access, pull request
  approval.
- **Microsoft GitHub admins** (Admin): Repository administration, branch
  protection, security settings.
- **Dependabot** (Automation): Automated dependency pull requests for GitHub
  Actions.
- **CLA bot** (Automation): Contributor License Agreement verification on pull
  requests.
...
- Responds to security reports in coordination with the
  [Microsoft Security Response Center (MSRC)][msrc].

### Contributor

- Submits bug reports, feature requests, and pull requests.
- Agrees to the [Contributor License Agreement (CLA)][cla] before contributions
  are accepted.
...
1. **Identity Verification**: The contributor's identity is verified through
   their association with a known trusted organization (e.g., Microsoft) or
...
Decisions are made through [GitHub Issues][githubissues] for proposals and
[Pull Requests][pullrequests] for code changes. New extensions or significant
changes must be discussed via GitHub Issues before implementation, as described
in [CONTRIBUTING.md][contributing].

[cla]: https://opensource.microsoft.com/cla
[contributing]: https://github.com/microsoft/PR-Metrics/blob/main/.github/CONTRIBUTING.md
[githubissues]: https://github.com/microsoft/PR-Metrics/issues
[msrc]: https://msrc.microsoft.com/
[omex]: https://github.com/orgs/microsoft/teams/omex
[prmetrics]: https://github.com/microsoft/PR-Metrics
[pullrequests]: https://github.com/microsoft/PR-Metrics/pulls
