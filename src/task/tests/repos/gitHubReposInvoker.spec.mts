...
import GetIssueCommentsResponse from "../../src/wrappers/octokitInterfaces/getIssueCommentsResponse.mjs";
import GetPullResponse from "../../src/wrappers/octokitInterfaces/getPullResponse.mjs";
import GitHubReposInvoker from "../../src/repos/gitHubReposInvoker.mjs";
...
import OctokitWrapper from "../../src/wrappers/octokitWrapper.mjs";
...
describe("gitHubReposInvoker.ts", (): void => {
  ...
  const expectedUserAgent = "PRMetrics/v1.6.5";
