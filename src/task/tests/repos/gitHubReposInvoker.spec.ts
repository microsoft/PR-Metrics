...
import type ErrorWithStatusInterface from "../../src/repos/interfaces/errorWithStatusInterface";
...
import type OctokitLogObjectInterface from "../wrappers/octokitLogObjectInterface";
